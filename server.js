...
app.get('/api/track/:orderId', async (req, res) => {
    try {
        ...
        const [orders] = await db.execute(
            'SELECT order_id, customer_name, order_status, payment_status, total_amount, created_at, estimated_delivery, tracking_id, payment_method FROM orders WHERE order_id = ? AND (payment_method != \'razorpay\' OR payment_status = \'paid\')',
            [req.params.orderId]
        );
